...
export default defineSchema({
  ...
  attendees: defineTable({
    ...
    rsvpStatus: v.union(v.literal("going"), v.literal("maybe"), v.literal("not-going")),
    plusOne: v.boolean(),
    plusOneName: v.optional(v.string()),
    dietaryRestrictions: v.optional(v.string()),
    userTokenIdentifier: v.optional(v.string()),
    responseSource: v.optional(v.union(v.literal("member"), v.literal("guest"))),
  })
    .index("by_event", ["eventId"])
    .index("by_event_and_rsvpStatus", ["eventId", "rsvpStatus"])
    .index("by_event_and_userTokenIdentifier", ["eventId", "userTokenIdentifier"])
  ...
  bringItems: defineTable({
    ...
    .index("by_event", ["eventId"])
    .index("by_event_and_claimedByTokenIdentifier", ["eventId", "claimedByTokenIdentifier"]),
  ...
  galleryPhotos: defineTable({
    ...
    .index("by_event", ["eventId"])
    .index("by_event_and_uploadedByTokenIdentifier", ["eventId", "uploadedByTokenIdentifier"]),
